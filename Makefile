...
# Generated by qmake (2.01a) (Qt 4.4.3) on: lun oct 13 22:12:16 2008
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bluetooth1.0.0/ && $(COPY_FILE) --parents src/textwindow/smstable.h src/qparser/parser.h src/filemanipulator/filemanipulator.h src/showwindow.h src/imagewindow/imagewindow.h src/textwindow/textwindow.h src/textwindow/maintxtwindow.h src/controllerwindow.h src/mainwidget.h src/debug.h .tmp/bluetooth1.0.0/ && $(COPY_FILE) --parents src/textwindow/smstable.cpp src/qparser/parser.cpp src/filemanipulator/filemanipulator.cpp src/showwindow.cpp src/imagewindow/imagewindow.cpp src/textwindow/textwindow.cpp src/textwindow/maintxtwindow.cpp src/controllerwindow.cpp src/mainwidget.cpp src/main.cpp .tmp/bluetooth1.0.0/ && $(COPY_FILE) --parents src/textwindow/maintxtwindow.ui .tmp/bluetooth1.0.0/ && (cd `dirname .tmp/bluetooth1.0.0` && $(TAR) bluetooth1.0.0.tar bluetooth1.0.0 && $(COMPRESS) bluetooth1.0.0.tar) && $(MOVE) `dirname .tmp/bluetooth1.0.0`/bluetooth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bluetooth1.0.0
