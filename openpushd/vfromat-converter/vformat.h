...
void vformat_remove_attributes (VFormat *vformat, const char *attr_group, const
char *attr_name);
...
void vformat_add_attribute_with_value (VFormat *vformat, VFormatAttribute *attr,
					const char *value);
					void vformat_add_attribute_with_values
(VFormat *vformat, VFormatAttribute					*attr,
...);
					void vformat_attribute_add_value
(VFormatAttribute *attr, const char *value);
					void vformat_attribute_add_value_decoded
(VFormatAttribute *attr, const char					*value,
int len);
					void vformat_attribute_add_values
(VFormatAttribute *attr, ...);
					void vformat_attribute_remove_values
(VFormatAttribute *attr);
					void vformat_attribute_remove_params
(VFormatAttribute *attr);
					
					/* attribute parameters */
					VFormatParam*
vformat_attribute_param_new (const char *param_name);
					void vformat_attribute_param_free
(VFormatParam *param);
					VFormatParam*
vformat_attribute_param_copy (VFormatParam *param);
					void vformat_attribute_add_param
(VFormatAttribute *attr, VFormatParam *param);
					VFormatParam
*vformat_attribute_find_param(VFormatAttribute *attr, const char		
		*name);
					void
...
vformat_attribute_add_param_with_values (VFormatAttribute *attr,
      ...
      void vformat_attribute_param_add_value (VFormatParam *param,
					...
					void vformat_attribute_param_add_values
(VFormatParam *param,
 ...
 GList* vformat_attribute_get_values (VFormatAttribute *attr); /* GList elements
										
									  are of
type char* */
										
										
 GList* vformat_attribute_get_values_decoded (VFormatAttribute *attr); /* GList	
...
of type GString* */
 ...
 const char *vformat_attribute_param_get_nth_value(VFormatParam *param, int
nth);
 
/* special TYPE= parameter predicate (checks for TYPE=@typestr */
gboolean vformat_attribute_has_type (VFormatAttribute *attr, const char
*typestr);
