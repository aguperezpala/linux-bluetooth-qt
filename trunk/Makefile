...
# Generated by qmake (2.01a) (Qt 4.4.3) on: jue oct 9 17:40:12 2008
...
SOURCES       = controllerwindow.cpp \
		showwindow.cpp \
		main.cpp \
		imagewindow.cpp moc_controllerwindow.cpp \
		moc_showwindow.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/windowflags1.0.0/ && $(COPY_FILE) --parents controllerwindow.h showwindow.h imagewindow.h .tmp/windowflags1.0.0/ && $(COPY_FILE) --parents controllerwindow.cpp showwindow.cpp main.cpp imagewindow.cpp .tmp/windowflags1.0.0/ && (cd `dirname .tmp/windowflags1.0.0` && $(TAR) windowflags1.0.0.tar windowflags1.0.0 && $(COMPRESS) windowflags1.0.0.tar) && $(MOVE) `dirname .tmp/windowflags1.0.0`/windowflags1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/windowflags1.0.0
