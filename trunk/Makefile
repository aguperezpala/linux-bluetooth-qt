...
# Generated by qmake (2.01a) (Qt 4.4.3) on: jue oct 30 17:15:38 2008
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/linux-bluetooth-qt1.0.0/ && $(COPY_FILE) --parents src/controllerwindow.h src/debug.h src/mainwidget.h src/showwindow.h src/filemanipulator/filemanipulator.h src/imagewindow/imagewindow.h src/qparser/parser.h src/textwindow/maintxtwindow.h src/textwindow/smsobject.h src/textwindow/smstable.h src/textwindow/textwindow.h src/textwindow/marquesinobj.h src/userspp/userobject.h src/net/userserver.h src/userspp/userlist.h .tmp/linux-bluetooth-qt1.0.0/ && $(COPY_FILE) --parents src/controllerwindow.cpp src/main.cpp src/mainwidget.cpp src/showwindow.cpp src/filemanipulator/filemanipulator.cpp src/imagewindow/imagewindow.cpp src/qparser/parser.cpp src/textwindow/maintxtwindow.cpp src/textwindow/smsobject.cpp src/textwindow/smstable.cpp src/textwindow/textwindow.cpp src/textwindow/marquesinobj.cpp src/userspp/userobject.cpp src/net/userserver.cpp src/userspp/userlist.cpp .tmp/linux-bluetooth-qt1.0.0/ && $(COPY_FILE) --parents src/mainwidget.ui src/textwindow/maintxtwindow.ui .tmp/linux-bluetooth-qt1.0.0/ && (cd `dirname .tmp/linux-bluetooth-qt1.0.0` && $(TAR) linux-bluetooth-qt1.0.0.tar linux-bluetooth-qt1.0.0 && $(COMPRESS) linux-bluetooth-qt1.0.0.tar) && $(MOVE) `dirname .tmp/linux-bluetooth-qt1.0.0`/linux-bluetooth-qt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/linux-bluetooth-qt1.0.0
