...
# Generated by qmake (2.01a) (Qt 4.4.3) on: sáb oct 11 14:01:04 2008
...
SOURCES       = src/controllerwindow.cpp \
		...
		src/main.cpp \
		src/imagewindow.cpp \
		src/textwindow.cpp moc_controllerwindow.cpp \
		moc_showwindow.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/windowflags1.0.0/ && $(COPY_FILE) --parents src/controllerwindow.h src/showwindow.h src/imagewindow.h src/textwindow.h .tmp/windowflags1.0.0/ && $(COPY_FILE) --parents src/controllerwindow.cpp src/showwindow.cpp src/main.cpp src/imagewindow.cpp src/textwindow.cpp .tmp/windowflags1.0.0/ && (cd `dirname .tmp/windowflags1.0.0` && $(TAR) windowflags1.0.0.tar windowflags1.0.0 && $(COMPRESS) windowflags1.0.0.tar) && $(MOVE) `dirname .tmp/windowflags1.0.0`/windowflags1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/windowflags1.0.0
...
moc_controllerwindow.cpp: src/imagewindow.h \
		src/showwindow.h \
		src/textwindow.h \
...
imagewindow.o: src/imagewindow.cpp src/imagewindow.h \
		src/showwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o imagewindow.o src/imagewindow.cpp

textwindow.o: src/textwindow.cpp src/textwindow.h \
		src/showwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o textwindow.o src/textwindow.cpp
