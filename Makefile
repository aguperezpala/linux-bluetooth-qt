...
# Generated by qmake (2.01a) (Qt 4.4.3) on: sáb oct 11 15:41:47 2008
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bluetooth1.0.0/ && $(COPY_FILE) --parents src/controllerwindow.h src/showwindow.h src/imagewindow/imagewindow.h src/textwindow/textwindow.h src/mainwidget.h .tmp/bluetooth1.0.0/ && $(COPY_FILE) --parents src/controllerwindow.cpp src/showwindow.cpp src/main.cpp src/imagewindow/imagewindow.cpp src/textwindow/textwindow.cpp src/mainwidget.cpp .tmp/bluetooth1.0.0/ && (cd `dirname .tmp/bluetooth1.0.0` && $(TAR) bluetooth1.0.0.tar bluetooth1.0.0 && $(COMPRESS) bluetooth1.0.0.tar) && $(MOVE) `dirname .tmp/bluetooth1.0.0`/bluetooth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bluetooth1.0.0
...
compiler_moc_header_make_all: moc_controllerwindow.cpp moc_showwindow.cpp moc_mainwidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_controllerwindow.cpp moc_showwindow.cpp moc_mainwidget.cpp
